...
namespace ASMHT_PH53971.Migrations
{
    ...
    [Migration("20250222201920_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ChiTietCombo", b =>
                {
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ChiTietDonHang", b =>
                {
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ChiTietGioHang", b =>
                {
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.Combo", b =>
                {
                    b.Property<int>("MaCombo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.DonHang", b =>
                {
                    b.Property<int>("MaDonHang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.GioHang", b =>
                {
                    b.Property<int>("MaGioHang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.MonAn", b =>
                {
                    b.Property<int>("MaMonAn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.Tag", b =>
                {
                    b.Property<int>("MaTag")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ChiTietCombo", b =>
                {
                    b.HasOne("ASMHT_PH53971.Models.Combo", "MaComboNavigation")
                        .WithMany("ChiTietCombos")
                        .HasForeignKey("MaCombo")
                        .IsRequired()
                        .HasConstraintName("FK__ChiTietCo__MaCom__3E52440B");

                    b.HasOne("ASMHT_PH53971.Models.MonAn", "MaMonAnNavigation")
                        .WithMany("ChiTietCombos")
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ChiTietDonHang", b =>
                {
                    ...
                    b.HasOne("ASMHT_PH53971.Models.DonHang", "MaDonHangNavigation")
                        .WithMany("ChiTietDonHangs")
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.ChiTietGioHang", b =>
                {
                    ...
                    b.HasOne("ASMHT_PH53971.Models.GioHang", "MaGioHangNavigation")
                        .WithMany("ChiTietGioHangs")
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.DonHang", b =>
                {
                    b.HasOne("ASMHT_PH53971.Models.ApplicationUser", "MaNguoiDungNavigation")
                        .WithMany("DonHangs")
            ...
            modelBuilder.Entity("ASMHT_PH53971.Models.MonAn", b =>
                {
                    b.HasOne("ASMHT_PH53971.Models.Tag", "MaTagNavigation")
                        .WithMany("MonAns")
                        .HasForeignKey("MaTag")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ASMHT_PH53971.Models.ApplicationUser", null)
                        .WithMany()
